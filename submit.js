function doGet(e) {
  try {
    // Handle data submitted via GET parameter
    if (e.parameter && e.parameter.data) {
      ...
      if (sheet.getLastRow() === 0) {
        sheet.appendRow([
          ...
          "Provincial Address", "Home Phone", "Mobile Phone",
          "Work Phone", "Personal Email", "Store Email",
          "Company", "Location", "Position", "Employee Number",
          "Date of Employment", "SSS/TIN", "Co-Borrower 1",
          "Co-Borrower 2", "Superior First", "Superior Last",
          "Superior Position", "Loan Proceeds", "Account Number"
        ]);
      }
